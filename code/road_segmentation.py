...
pothole_model = YOLO('C:\\Users\\Srikrishna\\Documents\\GitHub\\Sem_4\\Robotics-MFC-S4-D12\\best.pt')  # Adjust the path as necessary

# Define video input and output paths
video_path = 'demo.mp4'  # Replace with your video file path
output_path = 'segmented_road_output_1.mp4'
